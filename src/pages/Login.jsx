...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      {currenState === 'login' ? '' : <input type="text" className='w-full px-3 py-2 border border-gray-800' placeholder='Name' />}
      ...
      <button className='bg-black text-white font-light px-8 py-2 mt-4 '>{currenState === 'Login' ? 'Sign Up' : 'Sign Up'}</button>
